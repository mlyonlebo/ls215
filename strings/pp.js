...
// 3 Split the fullName variable into an array that contains the first 
...
// 4 Create a variable named language and set it equal to 'JavaScript'. 
// Find the index of the first occurrence of the letter 'S' and save it to 
// a variable named idx variable. Log the value of idx.
...
// 5 Call charCodeAt on the language variable with an argument of idx. 
...
// String.prototype.substr() has been deprecated. As a result, it should 
...
// console.log(language.substr(aIndex, vIndex));
...
// console.log(language.substring(aIndex, vIndex));
...
// 13 Create a variable named pi and set it to the result of 22 / 7. 
// Convert pi to a String using the toString method. Search the resulting 
// string for the final occurrence of '14', and log its index position.
...
// 14 Create a variable named boxNumber and set it to the result of 
// calling 356.toString(), and log the result. Before moving on, try 
// to run your program.
...
// Update your program again: eliminate the second period, and place 356 in parentheses, 
// then run the program again.


// 15 Convert the boxNumber variable back to a number using parseInt. 
...
if (input.endsWith('!')) {
  console.log(`HELLO ${input.slice(0, -1).toUpperCase()}.` + 
